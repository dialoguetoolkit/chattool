 ...
 * @author Greg
 */
public class MessageSubliminalStimuliDisplayText extends Message{
    ...
    public MessageSubliminalStimuliDisplayText(String text, Color textcolour, String nameOfBackgroundPanel,int positionX, int positionY, long lengthOfTime){
       super("server","server");
       this.text=text;
