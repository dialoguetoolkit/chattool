 ...
 * @author gj
 */
public class JPCTaskTGPANEL extends javax.swing.JPanel{

    /**
     * Creates new form JPCTask
     */
    public JPCTaskTGPANEL() {
        initComponents();
    }
    ...
    public JPCTaskTGPANEL(PCTaskTG pct) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JPCTaskTGPANEL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JPCTaskTGPANEL().setVisible(true);
            }
        });
    }
