 ...
 * @author gj
 */
public class JointReferenceTaskController_BACKUP implements JTrialTimerActionRecipientInterface {
   ...
   // double probabOfSame= 0.5;//CustomDialog.getDouble("Enter the probability of SAME stimuli", 0, 1, 0.5);
    ...
    public JointReferenceTaskController_BACKUP(DefaultConversationController cC) {
    ...
    public JointReferenceTaskController_BACKUP(DefaultConversationController cC, long durationOfStimulus){
