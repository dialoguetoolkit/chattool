 ...
 * @author LX1C
 */
public class JJPauser extends javax.swing.JFrame {

    /**
     * Creates new form JJPauser
     */
    public JJPauser() {
        super("GAMEINFO");
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JJPauser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
