...
public class MessageNewTangramsDirectorA extends MessageNewTangrams implements Serializable{
    
    public TangramSequence sequence;//sequence determining directors' complementary target tangrams
    
    public MessageNewTangramsDirectorA(String email, String userName, Vector<SerialTangram> v, String setName, TangramSequence sequence,String name)
    {
