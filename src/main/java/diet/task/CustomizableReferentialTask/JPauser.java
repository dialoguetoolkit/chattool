 ...
 * @author LX1C
 */
public class JPauser extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JPauser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
