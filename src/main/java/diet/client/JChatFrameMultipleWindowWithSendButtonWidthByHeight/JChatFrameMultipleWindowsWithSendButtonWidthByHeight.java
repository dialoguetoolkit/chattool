    ...
    public JChatFrameMultipleWindowsWithSendButtonWidthByHeight(ClientEventHandler clevh, int numberOfWindows, int mainWindowWidth, int mainWindowHeight,boolean isVertical,boolean hasStatusWindow,int windowOfOwnText, int textEntryWidth, int textEntryHeight, int maxCharlength, StyledDocumentStyleSettings styles) {
       ...
       // this.wstyles = styles;
        ...
        //this.getContentPane().add(jb, BorderLayout.EAST);
         ...
         JTextPaneNavigationFilter jtpnf = new JTextPaneNavigationFilter(jTextEntryPane, this);
...
public void changeJProgressBar(final String text,final Color colorForeground, int value){
           ...
           public void run(){
              try{
                ...
                if(jnp==null){
                      ...
                      jPanel1.add(jnp,BorderLayout.SOUTH);
                      jnp.setPreferredSize(new Dimension(jPanel2.getWidth(),25));
 ...
 public void changeInterfaceProperties(final String uniqueIDGeneratedByServer, final int newInterfaceproperties, final Object...values){
       ...
       final JChatFrameMultipleWindowsWithSendButtonWidthByHeight jf = this;
       ...
       SwingUtilities.invokeLater( new Runnable(){ public void run(){ 
                ...
                if (newInterfaceproperties==ClientInterfaceEventTracker.clearTextEntryField){
                    ...
                    jcfd.setPermitDeletes(false);
                     ...
                     JChatFrameMultipleWindowsWithSendButtonWidthByHeightDocument jcfd = ( JChatFrameMultipleWindowsWithSendButtonWidthByHeightDocument)jTextEntryPane.getDocument();
                     jcfd.setWhitelist((String)value1);         
                }
                else if (newInterfaceproperties == ClientInterfaceEventTracker.setCharLengthLimit){
                     System.err.println("WHITELIST IS: "+value1);
                     JChatFrameMultipleWindowsWithSendButtonWidthByHeightDocument jcfd = ( JChatFrameMultipleWindowsWithSendButtonWidthByHeightDocument)jTextEntryPane.getDocument();
                     maxcharlength=(int)value1;         
                }
...
public class DoScrolling implements Runnable{
  ...
  public class DoAppendTextWithCaretCheck implements Runnable{
          JChatFrameMultipleWindowsWithSendButtonWidthByHeight jcfmwwsbw;
          JTextPane jtp;
          String text;
          String prefix;
          String idToConfirm="";
          ...
          int windowNo;
           ...
           public DoAppendTextWithCaretCheck(JChatFrameMultipleWindowsWithSendButtonWidthByHeight jcfmwwsbw, JTextPane jtp, JScrollPane jsp, int windowNumber, String idTOCONFIRM, String prefix, boolean showPrefix, String text, Object attributeset, boolean bySelf){
              this.jtp =jtp;
              this.jsp = jsp;
              this.text=text;
