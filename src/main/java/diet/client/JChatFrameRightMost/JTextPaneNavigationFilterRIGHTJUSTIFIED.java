 ...
 * @author gj
 */
public class JTextPaneNavigationFilterRIGHTJUSTIFIED extends NavigationFilter{

    JTextPane jtp;
    JChatFrameMultipleWindowsWithSendButtonWidthByHeight jcfmpwwsbwbh;
    
    
    public JTextPaneNavigationFilterRIGHTJUSTIFIED(JTextPane jtp, JChatFrameMultipleWindowsWithSendButtonWidthByHeight jcfmpwwsbwb ) {
       this.jtp=jtp;
