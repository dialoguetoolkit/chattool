 ...
 * @author gj
 */
public class JInterfaceSinglePressButtonFIVE extends javax.swing.JFrame {
     ...
     */
    public JInterfaceSinglePressButtonFIVE() {
        initComponents();
    ...
    public JInterfaceSinglePressButtonFIVE(JInterfaceMenuButtonsReceiverInterface jimbr) {
        initComponents();
        this.setVisible(true);
        this.jimbr=jimbr;
        this.jToggleButton1.setSelected(false);
    ...
    public JInterfaceSinglePressButtonFIVE(String title,JInterfaceMenuButtonsReceiverInterface jimbr, String name1, String name2, String name3, String name4, String name5) {
        super(title);
        initComponents();
        this.setTitle("Please choose: "+name1+", "+name2+", "+name3+", "+name4+", "+name5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JInterfaceSinglePressButtonFIVE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JInterfaceSinglePressButtonFIVE().setVisible(true);
            }
        });
    }
