 ...
 * @author LX1C
 */
public class Telegram_Dyadic_Automatic_Start extends TelegramController{
   ...
   // Participant pMatcher;
    ...
    public Telegram_Dyadic_Automatic_Start(Conversation c) {
        super(c);
       
    }

    public Telegram_Dyadic_Automatic_Start(Conversation c, long istypingtimeout) {
