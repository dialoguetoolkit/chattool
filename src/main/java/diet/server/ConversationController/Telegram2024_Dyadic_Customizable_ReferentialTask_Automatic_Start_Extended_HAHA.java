 ...
 * @author LX1C
 */
public class Telegram2024_Dyadic_Customizable_ReferentialTask_Automatic_Start_Extended_HAHA extends TelegramController implements JInterfaceMenuButtonsReceiverInterface{
   ...
   // Participant pMatcher;
    ...
    public Telegram2024_Dyadic_Customizable_ReferentialTask_Automatic_Start_Extended_HAHA(Conversation c) {
        super(c);
       
    }

    public Telegram2024_Dyadic_Customizable_ReferentialTask_Automatic_Start_Extended_HAHA(Conversation c, long istypingtimeout) {
