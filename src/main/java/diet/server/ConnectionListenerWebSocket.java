 ...
 * @author user
 */
public class ConnectionListenerWebSocket extends Thread {
    ...
    public static ConnectionListenerWebSocket thisConnectionListener;


    public ConnectionListenerWebSocket(ExperimentManager experimentM, int portNumber) {
        expM = experimentM;
        serverSocket = null;
